...
class DesignUndergroundSystem {
    ...
    // Time Complexity: O(1)
    // Space Complexity: O()O(P+S^2), where S is the number of stations on the
    // network, and P is the number of passengers making a journey concurrently
    // during peak time.
    ...
    public void checkOut(int id, String stationName, int t) {
        ...
        Painter<String, Integer> checkInDataForId = checkInData.get(id);
        ...
        // Note that this is optional, we'll talk about it in the space complexity
        // analysis.
